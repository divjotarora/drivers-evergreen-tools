...
EOF_HAPROXY_CONFIG
  ...
  echo 'SINGLE_MONGOS_LB_URI: "'$SINGLE_MONGOS_LB_URI'"' > $DRIVERS_TOOLS/lb-expansion.yml
  echo 'MULTI_MONGOS_LB_URI: "'$MULTI_MONGOS_LB_URI'"' >> $DRIVERS_TOOLS/lb-expansion.yml
